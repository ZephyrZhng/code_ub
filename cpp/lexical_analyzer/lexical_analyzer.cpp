...
void LexicalAnalyzer::showKeywordAndSymbol()
{
...
void LexicalAnalyzer::showTokenSeq()
{
	cout << "token sequence: ";
...
void LexicalAnalyzer::showIDTab()
{
	cout << "id table: ";
...
void LexicalAnalyzer::showChTab()
{
...
void LexicalAnalyzer::showStrTab()
{
	cout << "string table: ";
...
void LexicalAnalyzer::shiowConstTab()
{
	cout << "constant table: ";
...
void LexicalAnalyzer::showKeywordTab()
{
	cout << "keyword table: ";
...
void LexicalAnalyzer::showSymbolTab()
{
	cout << "symbol table: ";
